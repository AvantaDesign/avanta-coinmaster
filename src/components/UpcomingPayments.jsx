  ...
  if (upcomingPayments.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-500 text-sm">No tienes pagos próximos en los siguientes 30 días.</p>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow">
            ...
            >
              ...
              <div className="mt-3">
                <button
                  ...
                  className="w-full px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center"
                >
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-200">
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">Total a pagar en 30 días:</span>
        ...
        {upcomingPayments.some(p => p.minimumPayment > 0) && (
          <div className="flex items-center justify-between text-sm mt-2">
            <span className="text-gray-600">Pagos mínimos totales:</span>
