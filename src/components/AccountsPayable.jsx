...
export default function AccountsPayable() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Payment Form */}
      {paymentForm.id && (
        <form onSubmit={handlePayment} className="bg-white p-6 rounded-lg shadow-md border-2 border-green-500">
        ...
        <div className="bg-white rounded-lg shadow-md">
          <div className="p-4 border-b flex gap-2">
            ...
            <button
              ...
              className={`px-3 py-1 rounded ${filterStatus === 'overdue' ? 'bg-red-600 text-white' : 'bg-gray-200'}`}
            >
              Vencidas
            </button>
            <button
              onClick={() => setFilterStatus('paid')}
              className={`px-3 py-1 rounded ${filterStatus === 'paid' ? 'bg-green-600 text-white' : 'bg-gray-200'}`}
            >
              Pagadas
            </button>
          </div>
          {loading ? (
            ...
            <div className="p-6 text-center text-gray-500">No hay cuentas por pagar</div>
          ) : (
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="text-sm text-gray-700 font-medium">Futuro</div>
              <div className="text-2xl font-bold text-gray-900">{formatCurrency(schedule.future.total)}</div>
              <div className="text-xs text-gray-600">{schedule.future.count} pagos</div>
            </div>
          </div>
          <div className="bg-white p-4 rounded-lg shadow-md">
            ...
            <div className="text-sm text-gray-600">{schedule.totalCount} pagos pendientes</div>
          </div>
        </div>
      )}
      ...
      {view === 'vendors' && (
        <div className="bg-white rounded-lg shadow-md">
          {vendors.length === 0 ? (
            <div className="p-6 text-center text-gray-500">No hay proveedores</div>
          ) : (
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
      ...
      {view === 'metrics' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="text-2xl font-bold text-gray-900">{formatCurrency(metrics.totalBilled)}</div>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-sm text-gray-600">Tasa de Pago</div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md md:col-span-2 lg:col-span-4">
            <div className="text-sm text-gray-600">Tasa de Pagos a Tiempo</div>
