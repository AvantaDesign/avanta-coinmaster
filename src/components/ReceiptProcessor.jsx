      ...
      {ocrResult && (
        <div className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <pre className="text-xs text-gray-600 dark:text-gray-400 whitespace-pre-wrap overflow-x-auto max-h-48 overflow-y-auto bg-white dark:bg-slate-800 p-3 rounded border border-gray-200 dark:border-slate-600">
              {ocrResult.text}
            </pre>
          </div>
