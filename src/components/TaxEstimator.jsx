    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-red-50 p-4 rounded-lg border border-red-200">
          <div className="text-xs text-gray-600 mb-1">ISR</div>
        ...
        <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
          <div className="text-xs text-gray-600 mb-1">IVA</div>
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          <div className="text-xs text-gray-600 mb-1">Total a Pagar</div>
      ...
      <div className="bg-blue-50 p-4 rounded-lg mb-4">
        <div className="flex justify-between items-center">
          <div>
            <div className="text-sm text-gray-600">Utilidad Gravable</div>
          ...
          {data.ivaDetails && (
            <>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">IVA Cobrado (16%)</span>
                <span className="font-medium">{formatCurrency(data.ivaDetails.ivaCobrado)}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">IVA Pagado (16%)</span>
          ...
          {data.businessIncome !== undefined && (
            <>
              <div className="flex justify-between text-sm pt-2 border-t">
                <span className="text-gray-600">Ingresos de Negocio</span>
