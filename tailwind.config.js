  ...
  theme: {
    extend: {
      colors: {
        ...
        // Primary blues - cool and professional with improved contrast
        'primary': {
          50: '#f0f4f9',
          100: '#e1e8f4',
          200: '#c3d1e8',
          300: '#a5badd',
          400: '#8fa9e8', // Lighter for better dark mode contrast
          500: '#6b8dd6', // Brighter accent blue for dark mode
          600: '#4a5fa8', // Dark blue
          700: '#3d4d8a',
          800: '#2d3a66',
          900: '#1a2341',
        },
        // Success - cool green with improved contrast
        'success': {
          50: '#f0f4f1',
          100: '#dce6df',
          200: '#b8cdbf',
          300: '#94b49e',
          400: '#7db096', // Lighter for better dark mode contrast
          500: '#6aaa85', // Brighter green for dark mode
          600: '#4a7660',
          700: '#3a6250',
          800: '#2a4d40',
          900: '#1a3830',
        },
        // Warning - cool amber with improved contrast
        'warning': {
          50: '#faf7f2',
          100: '#f5eee2',
          200: '#ebdcc5',
          300: '#dfc7a4',
          400: '#e4c490', // Lighter for better dark mode contrast
          500: '#d9ad6e', // Brighter amber for dark mode
          600: '#b08450',
          700: '#936d42',
          800: '#755634',
          900: '#573f26',
        },
        // Danger - cool red with improved contrast
        'danger': {
          50: '#faf3f1',
          100: '#f5e5e1',
          200: '#ebccc3',
          300: '#dfa69d',
          400: '#e68e8c', // Lighter for better dark mode contrast
          500: '#db6c6a', // Brighter red for dark mode
          600: '#b04645',
          700: '#933a38',
          800: '#752d2b',
          900: '#57201f',
        },
        // Info - cool cyan with improved contrast
        'info': {
          50: '#f0f8fb',
          100: '#dff0f8',
          200: '#bfe0f0',
          300: '#9ecfe8',
          400: '#8bc8ec', // Lighter for better dark mode contrast
          500: '#6ebce5', // Brighter cyan for dark mode
          600: '#4a8fbd',
          700: '#3d769f',
          800: '#2d5980',
          900: '#1a3861',
