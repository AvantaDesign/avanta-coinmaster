-- ============================================================================
-- MIGRATION 048C: Create 3 Realistic Demo Scenarios
-- ============================================================================
-- Phase 46: Integration Testing & Quality Assurance
-- 
-- This migration creates 3 realistic demo scenarios using existing types:
-- 1. Excelente (healthy): +$100,000 MXN
-- 2. Regular (healthy): +$10,000 MXN  
-- 3. Malo (critical): -$20,000 MXN
-- ============================================================================
...
-- Scenario 2: Regular (Healthy Business)
(
    2,
    'Negocio Regular',
    'healthy',
...
-- Scenario 3: Malo (Critical Business)
(
    3,
...
-- ============================================================================
-- DEMO DATA SNAPSHOTS - EXCELLENT SCENARIO (ID=1)
-- ============================================================================
...
-- Transactions for Excellent Scenario (20+ transactions)
INSERT INTO demo_data_snapshots (scenario_id, snapshot_name, data_type, data_snapshot) VALUES (
    1,
...
-- ============================================================================
-- DEMO DATA SNAPSHOTS - REGULAR SCENARIO (ID=2)
-- ============================================================================
...
-- Transactions for Regular Scenario (15+ transactions)
INSERT INTO demo_data_snapshots (scenario_id, snapshot_name, data_type, data_snapshot) VALUES (
    2,
...
-- ============================================================================
-- DEMO DATA SNAPSHOTS - STRUGGLING SCENARIO (ID=3)
-- ============================================================================
...
-- Transactions for Struggling Scenario (15+ transactions showing crisis)
INSERT INTO demo_data_snapshots (scenario_id, snapshot_name, data_type, data_snapshot) VALUES (
    3,
...
-- COMPLETION MESSAGE
-- ============================================================================
-- Migration 048C completed successfully
-- Created 3 realistic demo scenarios:
-- 1. Negocio Excelente (healthy) - +$100,000 MXN
-- 2. Negocio Regular (healthy) - +$10,000 MXN  
-- 3. Negocio en Problemas (critical) - -$20,000 MXN
-- 
-- Features:
-- - 3 scenario levels with realistic amounts
-- - 20+ transactions for excellent scenario
-- - 15+ transactions for regular scenario
-- - 15+ transactions for struggling scenario
